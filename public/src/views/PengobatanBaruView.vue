<template>
    ...
    <div class="form">    
      <form id="frm-prs" @submit.prevent="addpengobatanhewan">
        <div class="wrapper">
          <label for="id" class="labelfrm">ID: </label><br>
          <input type="text" name="id" id="id" size="5" v-model="pengobatanhewan.id" placeholder="A-XXX"/><br>
        </div><br>
    
        <div class="wrapper">
          <label for="nama" class="labelfrm">Jenis Pengobatan: </label><br>
          <input type="text" name="nama" id="nam" maxlength="30" size="20" v-model="pengobatanhewan.jenispengobatan" placeholder="xxxx"/><br>
        </div><br>

        <div class="wrapper">
          <label for="nama" class="labelfrm">Tanggal: </label><br>
          <input type="date" name="tanggal" id="tgl" v-model="pengobatanhewan.tanggal" /><br>
        </div><br>
    
        <div class="wrapper">
          <label for="submit" class="labelfrm" ></label>
          <input type="submit" name="Submit" value="Submit"  onclick="window.location.href = 'pengobatan';"/>
        </div>
      </form>
    </div>
    </template>
    ...
    export default {
      ...
      methods: {
        addpengobatanhewan() {
          (async () => {
            await setDoc(doc(collection(db, "pengobatanhewan")), this.pengobatanhewan);
          })();
        },
      }
    }
